...
{
    public static class Payment//should this be static? don't think they need to create another payment object, so it should probably be static
    {
        ...
        //public Payment(double subTotal, double tax, double grandTotal)... don't know if we need these
        //{
        //    SubTotal = subTotal;
        //    Tax = tax;
